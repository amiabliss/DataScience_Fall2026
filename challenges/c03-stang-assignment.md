...
- Is there “one true value” for the material properties of Aluminum?
  - No. The values vary across samples.
- How many aluminum alloys are in this dataset? How do you know?
  - There is only one aluminum alloy in this dataset. In the summary,
    the N.unique is 1, meaning there is only 1 unique value and all are
    the same.
- What angles were tested?
  - Based on the summary, the angles tested were 0, 45, and 90.
- What thicknesses were tested?
  - The thicknesses tested were 0.022, 0.032, 0.064, and 0.081.
- **Does the elastic modulus change across testing angles in a way that
  relates to material anisotropy?**
  - Aluminum crystal has different stiffness based on the crystal
    lattice. Aligning these crystals creatrs mechanical anisotropy,
    altering the stiffness of the overall material based on the rolling
    direction.
...
- There doesn’t seem to be evidence of anisotropy. The
  distribution/range of the E values look almost identical.
- Based on this, the anisotropy in this specific alloy is negligible or
  very minimal.
- E does have a pattern related to plate thickness, with 0.081 being the
  lowest at each angle and the highest at 0.064.
- This could mean that a processing differences between different
  thicknesses has a larger impact on E, but there is not enough data to
  be sure.
...
- Does this graph support or contradict the claim above?
  - This contradicts the claim that E is an intensive material property.
    If it were an intensive property, the data points would align around
    a specific value independent to plate thickness. Instead, we see
    specific grouping that relates somewhat to thickness, with 0.081
    clustering around lower E and nu values and 0.022 averaging higher E
    values.
- Is this evidence *conclusive* one way or another?
  - This evidence is not conclusive. It does show that the E values vary
    across thicknesses, but we cannot identify the root cause without
    other information. The difference in values could be related to
    grain size, heat treatments, quench rates, etc.
